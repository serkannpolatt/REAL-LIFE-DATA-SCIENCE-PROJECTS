...
from langchain_groq import ChatGroq  # type: ignore # type: ignore
from langchain_core.runnables import RunnablePassthrough
from langchain_core.output_parsers import StrOutputParser
from dotenv import load_dotenv, find_dotenv
from nemoguardrails import RailsConfig  # type: ignore # type: ignore
from nemoguardrails.integrations.langchain.runnable_rails import RunnableRails  # type: ignore
import bs4
import os
import time
...
class RAG:
    def __init__(self, web_url):
        ...
        self.groq_llm = ChatGroq(
            api_key=os.getenv("GROQ_API_KEY"), model="llama3-70b-8192", temperature=0
        )
        ...
        self.rag_prompt = hub.pull(
            "rlm/rag-prompt", api_key=os.getenv("LANGSMITH_API_KEY")
        )
    ...
    def create_pinecone_index(self, vectorstore_index_name):
        ...
        pc.create_index(
            vectorstore_index_name, dimension=1536, metric="dotproduct", spec=spec
        )
